...
export class AddCoreEntities1758453872027 implements MigrationInterface {
    name = 'AddCoreEntities1758453872027'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "association_role" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(12) NOT NULL, "description" text, "permissions" "public"."association_role_permissions_enum" array NOT NULL DEFAULT '{}', "createdById" uuid, "associationId" uuid, "timestampsCreated_at" TIMESTAMP NOT NULL DEFAULT now(), "timestampsUpdated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_1eedbb7007f0340dcd7732bfe6b" UNIQUE ("name", "associationId"), CONSTRAINT "PK_5b3f3ce0d1d7a0558cf1d81b97b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "fundraising" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(100) NOT NULL, "description" text, "amount" double precision NOT NULL DEFAULT '0', "wantedAmount" double precision NOT NULL DEFAULT '0', "startDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "endDate" TIMESTAMP WITH TIME ZONE DEFAULT now(), "createdById" uuid, "associationId" uuid, "timestampsCreated_at" TIMESTAMP NOT NULL DEFAULT now(), "timestampsUpdated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2b493d5862734cb2567b0c0b931" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "event_register" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "registeredAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "eventPricingId" uuid, CONSTRAINT "UQ_67695eda41d78748b02958c31b8" UNIQUE ("userId", "eventPricingId"), CONSTRAINT "PK_105f02d2667607dec5c38e92999" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."transaction_relatedto_enum" AS ENUM('Fundraising', 'Event', 'Association', 'Announcement')`);
        await queryRunner.query(`CREATE TABLE "transaction" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" double precision NOT NULL, "relatedTo" "public"."transaction_relatedto_enum" NOT NULL, "relatedBy" character varying NOT NULL, "invoicePath" character varying(255) NOT NULL, "userId" uuid, "timestampsCreated_at" TIMESTAMP NOT NULL DEFAULT now(), "timestampsUpdated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_89eadb93a89810556e1cbcd6ab9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "association" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "description" text, "primaryColor" character varying(7) DEFAULT '#000000', "secondaryColor" character varying(7) DEFAULT '#000000', "contact" character varying(100), "createdById" uuid, "timestampsCreated_at" TIMESTAMP NOT NULL DEFAULT now(), "timestampsUpdated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5c770cfef7a1f66da23be411699" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "association_announcement" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(100) NOT NULL, "content" text, "isActive" boolean NOT NULL DEFAULT true, "createdById" uuid, "associationId" uuid, "timestampsCreated_at" TIMESTAMP NOT NULL DEFAULT now(), "timestampsUpdated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ffaafdc856358de57e485ca0a15" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_association" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "associationId" uuid NOT NULL, "roleId" uuid, CONSTRAINT "UQ_d156fec5eab2d0ebc211879a1c7" UNIQUE ("userId", "associationId"), CONSTRAINT "PK_f02d05834dc4241c6956413f835" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "association_role" ADD CONSTRAINT "FK_0bd84288695aef68e8100b25070" FOREIGN KEY ("createdById") REFERENCES "user_association"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "fundraising" ADD CONSTRAINT "FK_ddf78072388f370597da041de0f" FOREIGN KEY ("createdById") REFERENCES "user_association"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "event" ADD CONSTRAINT "FK_1d5a6b5f38273d74f192ae552a6" FOREIGN KEY ("createdById") REFERENCES "user_association"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "event_register" ADD CONSTRAINT "FK_647f9df50b854c2f660e91f48c8" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "association_announcement" ADD CONSTRAINT "FK_d0a7841c7e05009b4f30e9ebd54" FOREIGN KEY ("createdById") REFERENCES "user_association"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "association_announcement" DROP CONSTRAINT "FK_d0a7841c7e05009b4f30e9ebd54"`);
        ...
        await queryRunner.query(`ALTER TABLE "event_register" DROP CONSTRAINT "FK_647f9df50b854c2f660e91f48c8"`);
        ...
        await queryRunner.query(`ALTER TABLE "fundraising" DROP CONSTRAINT "FK_ddf78072388f370597da041de0f"`);
        await queryRunner.query(`ALTER TABLE "association_role" DROP CONSTRAINT "FK_066fe7b887c6ba639f08646cd7e"`);
        await queryRunner.query(`ALTER TABLE "association_role" DROP CONSTRAINT "FK_0bd84288695aef68e8100b25070"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."transaction_relatedto_enum"`);
